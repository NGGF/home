jQ(function(){
	...
	var p = jQ(".div_center:eq(0)").parent();
...
{
	winObj= window.open(url,title,'width='+width+',height='+height+',menubar=no,scrollbars=yes,resizable=yes');
}
...
function newCalendar(objId){
	...
	/*舊的hycase日期元件*/
//	jQ("#"+objId.replace('.', '\\.')).datepicker({
//		showButtonPanel: true,
//		changeMonth: true,
//		changeYear: true,
//		showOn: "button",
//		buttonImage: _cp + "/js/jquery/themes/calendar-icon.png",
//		buttonImageOnly: true,
//		dateFormat : "yy/mm/dd"
//	});
	
	/*新的hycase日期，dynDateTime元件*/
	jQ("#"+objId.replace('.', '\\.')).after("<img src='" + _cp + "/images/icon_calendar.gif" + "'/>").dynDateTime({
		button: ".next()"
	});
}
